...
namespace Gurcom.Notify.Views
{
    ...
    public partial class MainPage : MasterDetailPage
    {
        ...
        public MainPage()
        {
         ...
         //   MenuPages.Add((int)MenuItemType.Customer, (NavigationPage)Detail);
        }
            ...
            if (!MenuPages.ContainsKey(id))
            {
                switch (id)
                {
                    ...
                    case (int)MenuItemType.Purchase:
                        MenuPages.Add(id, new NavigationPage(new PurchaseList()));
                        break;
                    case (int)MenuItemType.Company:
                        MenuPages.Add(id, new NavigationPage(new CompanySetting()));
                        break;
